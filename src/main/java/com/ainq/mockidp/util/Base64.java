...
public class Base64 {
  ...
  public static String encodeObject(java.io.Serializable serializableObject, int options) {
    ...
    try {
      ...
      try {
        ...
        log.error("Error closing oos");
      }
      closeStreams(baos, b64os, gzos);
    } // end finally
  ...
  private static void closeStreams(ByteArrayOutputStream baos, java.io.OutputStream b64os,
      GZIPOutputStream gzos) {
    try {
      if (gzos != null)
        gzos.close();
    } catch (Exception e) {
      log.error("Error closing gzos");
    }
    try {
      if (b64os != null)
        b64os.close();
    } catch (Exception e) {
      log.error("Error closing b64os");
    }
    try {
      if (baos != null)
        baos.close();
    } catch (Exception e) {
      log.error("Error closing baos");
    }
  }
      ...
      if (java.util.zip.GZIPInputStream.GZIP_MAGIC == head) {
        ...
        try {
          ...
          try {
            ...
            log.error("Error closing gzis");
          }
          try {
            if (bais != null)
              bais.close();
          } catch (Exception e) {
            log.error("Error closing bais");
          }
        } // end finally
